...
- **FR-003**: The system MUST request only `files:read` for Figma and MUST NOT include any additional scope that the read-only tools do not require (least privilege).
